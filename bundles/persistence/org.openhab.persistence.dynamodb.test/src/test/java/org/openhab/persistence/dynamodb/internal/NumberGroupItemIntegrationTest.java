 ...
 *
 */
public class NumberGroupItemIntegrationTest extends AbstractTwoItemIntegrationTest {

    private static final String name = "group_number";
    ...
    public static void storeData() throws InterruptedException {
        GroupItem item = (GroupItem) items.get(name);
