...
public class ReadCoilsAndDiscreteTestCase extends TestCaseSupport {
	...
	public static Collection<Object[]> parameters() {
		...
		List<Object[]> baseParameters = Arrays.asList(new Object[][] {
				{ false, ModbusBindingProvider.TYPE_COIL,
						SimpleDigitalOut.class, "addDigitalOut",
						DigitalOut.class },
				{ true, ModbusBindingProvider.TYPE_COIL,
						SimpleDigitalOut.class, "addDigitalOut",
						DigitalOut.class },
				{ false, ModbusBindingProvider.TYPE_DISCRETE,
						SimpleDigitalIn.class, "addDigitalIn",
						DigitalIn.class },
				{ true, ModbusBindingProvider.TYPE_DISCRETE,
						SimpleDigitalIn.class, "addDigitalIn",
						DigitalIn.class } });
	...
	public ReadCoilsAndDiscreteTestCase(ServerType serverType, boolean nonZeroOffset, String type,
			Class<Register> storeClass, String spiAddRegisterMethodName,
	 ...
	 */
	@Test
	public void testReadDigitals() throws InterruptedException,
