        ...
        List<Object[]> parameters = Arrays.<Object[]> asList(
                ...
                new Object[] { new StringItem("item1"), "slave1:99",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.STATE, Arrays.asList(), Arrays.asList()) },
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.COMMAND, Arrays.asList(), Arrays.asList()) },
                        null },
                ...
                new Object[] { new StringItem("item1"), "slave1:<100:>99",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 100, IOType.STATE, Arrays.asList(), Arrays.asList()) },
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.COMMAND, Arrays.asList(), Arrays.asList()) },
                        null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("TRANSFORMATION", null, null), "int32", Arrays.asList(),
                                Arrays.asList()) },
                ...
                new Object[] { new StringItem("item2"), "<[slave1:99:transformation=TRANSFORMATION]",
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "default",
                                new Transformation("TRANSFORMATION", null, null), "default", Arrays.asList(),
                                Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"), "<[slave1:99:trigger=*,transformation=default,valueType=int32]",
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                Transformation.IDENTITY_TRANSFORMATION, "int32", Arrays.asList(), Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", Arrays.asList(),
                                Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", Arrays.asList(), Arrays.asList()),
                                new ItemIOConnection("slave2", 98, IOType.STATE, "*",
                                        new Transformation("", "FUN", "getValue2.js"), "uint16", Arrays.asList(),
                                        Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", Arrays.asList(), Arrays.asList()),
                                new ItemIOConnection("slave2", 98, IOType.STATE, "*",
                                        new Transformation("", "REGEX", ",.*,"), "uint16", Arrays.asList(),
                                        Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                ...
                                new ItemIOConnection("slave3", 97, IOType.STATE, "*",
                                        new Transformation("", "REGEX", ",.*,"), "float32", Arrays.asList(),
                                        Arrays.asList()) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave3", 97, IOType.COMMAND, "ThisIsTrigger",
                                new Transformation("", "FOOBAR", "=\",.*[:]),"), "float32", Arrays.asList(),
                                Arrays.asList()) },
                        null },
                ...
                new Object[] { new StringItem("item2"), "<[slave1:101]",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 101, IOType.STATE, Arrays.asList(), Arrays.asList()) },
                        new ItemIOConnection[0], null },
