...
public class ModbusBindingConfigTest {
    ...
    private static List<Class<? extends Command>> STRING_COMMANDS = new StringItem("").getAcceptedCommandTypes();
    private static List<Class<? extends State>> STRING_STATES = new StringItem("").getAcceptedDataTypes();

    private static List<Class<? extends Command>> NUMBER_COMMANDS = new NumberItem("").getAcceptedCommandTypes();
    private static List<Class<? extends State>> NUMBER_STATES = new NumberItem("").getAcceptedDataTypes();
        ...
        List<Object[]> parameters = Arrays.<Object[]> asList(
                ...
                new Object[] { new StringItem("item1"), "slave1:99",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.STATE, STRING_COMMANDS, STRING_STATES) },
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.COMMAND, STRING_COMMANDS, STRING_STATES) },
                        null },

                // Simple case different item type
                new Object[] { new NumberItem("item1"), "slave1:99",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.STATE, NUMBER_COMMANDS, NUMBER_STATES) },
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.COMMAND, NUMBER_COMMANDS, NUMBER_STATES) },
                        null },
                ...
                new Object[] { new StringItem("item1"), "slave1:<100:>99",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 100, IOType.STATE, STRING_COMMANDS, STRING_STATES) },
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 99, IOType.COMMAND, STRING_COMMANDS, STRING_STATES) },
                        null },
                ...
                new Object[] { new StringItem("item1"), "slave1", null, null,
                        new BindingConfigParseException("Invalid number of registers in item 'item1' configuration") },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("TRANSFORMATION", null, null), "int32", STRING_COMMANDS,
                                STRING_STATES) },
                ...
                new Object[] { new StringItem("item2"), "<[slave1:99:transformation=TRANSFORMATION]",
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "default",
                                new Transformation("TRANSFORMATION", null, null), "default", STRING_COMMANDS,
                                STRING_STATES) },
                        new ItemIOConnection[0], null },
                // extended, single read, default transformation
                new Object[] { new StringItem("item2"), "<[slave1:99:trigger=*,transformation=default,valueType=int32]",
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                Transformation.IDENTITY_TRANSFORMATION, "int32", STRING_COMMANDS, STRING_STATES) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", STRING_COMMANDS, STRING_STATES) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                ...
                                new ItemIOConnection("slave2", 98, IOType.STATE, "*",
                                        new Transformation("", "FUN", "getValue2.js"), "uint16", STRING_COMMANDS,
                                        STRING_STATES) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", STRING_COMMANDS, STRING_STATES),
                                new ItemIOConnection("slave2", 98, IOType.STATE, "*",
                                        new Transformation("", "REGEX", ",.*,"), "uint16", STRING_COMMANDS,
                                        STRING_STATES) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.STATE, "*",
                                ...
                                new ItemIOConnection("slave3", 97, IOType.STATE, "*",
                                        new Transformation("", "REGEX", ",.*,"), "float32", STRING_COMMANDS,
                                        STRING_STATES) },
                        new ItemIOConnection[0], null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] {},
                        new ItemIOConnection[] { new ItemIOConnection("slave3", 97, IOType.COMMAND, "ThisIsTrigger",
                                new Transformation("", "FOOBAR", "=\",.*[:]),"), "float32", STRING_COMMANDS,
                                STRING_STATES) },
                        null },
                ...
                new Object[] { new StringItem("item2"),
                        ...
                        new ItemIOConnection[] { new ItemIOConnection("slave1", 99, IOType.COMMAND, "*",
                                new Transformation("", "JS", "getValue.js"), "int32", STRING_COMMANDS, STRING_STATES),
                        ...
                        null },
                // invalid valuetype
                new Object[] { new StringItem("item2"), "<[slave1:99:trigger=*,valueType=invalidValueType]", null, null,
                        new BindingConfigParseException(
                ...
                new Object[] { new StringItem("item2"), "<[slave1:101]",
                        new ItemIOConnection[] {
                                new ItemIOConnection("slave1", 101, IOType.STATE, STRING_COMMANDS, STRING_STATES) },
                        new ItemIOConnection[0], null },
    ...
    public void testParsing() throws BindingConfigParseException {
        ...
        assertThat(config.getItemClass(), is(equalTo(this.item.getClass())));
