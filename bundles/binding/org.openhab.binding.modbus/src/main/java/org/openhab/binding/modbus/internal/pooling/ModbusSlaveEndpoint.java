...
/**
 * ModbusSlaveEndpoint contains minimal connection information to establish connection to the slave. End point
 * can be used to differentiate slaves such that read/write transactions are processed one at a time if
